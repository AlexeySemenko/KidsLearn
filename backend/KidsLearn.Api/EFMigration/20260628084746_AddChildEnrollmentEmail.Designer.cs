...
namespace KidsLearn.Api.EFMigration
{
    ...
    [Migration("20260628084746_AddChildEnrollmentEmail")]
    partial class AddChildEnrollmentEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 28, 8, 47, 45, 731, DateTimeKind.Utc).AddTicks(3526),
            ...
            modelBuilder.Entity("AssignmentAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Child", b =>
                {
                    ...
                    b.Property<string>("EnrollmentEmail")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ChildFriendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LessonRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LessonId", "RevisionNumber")
                        .IsUnique();

                    b.ToTable("LessonRevisions");
                });

            modelBuilder.Entity("ParentAccountLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ParentAId", "ParentBId")
                        .IsUnique();

                    b.ToTable("ParentAccountLinks");
                });
            ...
            modelBuilder.Entity("AssignmentAnswer", b =>
                {
                    ...
                    b.HasOne("AnswerOption", "SelectedAnswerOption")
                        .WithMany()
            ...
            modelBuilder.Entity("ChildFriendship", b =>
                {
                    b.HasOne("Child", "Acceptor")
                        .WithMany()
                        .HasForeignKey("AcceptorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Child", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("ParentAccountLink", b =>
                {
                    b.HasOne("AppUser", "ParentA")
                        .WithMany()
                        .HasForeignKey("ParentAId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppUser", "ParentB")
                        .WithMany()

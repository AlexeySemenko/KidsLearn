...
{
    /// <inheritdoc />
    public partial class AddCoreDomainV1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Children_ChildId",
                        column: x => x.ChildId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 6, 4, 15, 10, 14, 720, DateTimeKind.Utc).AddTicks(5158), "parent@example.com", 1 });
